...
onready var coins_number = $CoinsUI/CoinsNum
onready var wood_number = $WoodUI/WoodNum
onready var brick_number = $BrickUI/BrickNum
onready var health_number = $HealthUI/HealthNum
...
func _ready():
	...
	get_node("Hotbar").initialize_hotbar()
...
func initialize_inventory():
	...
	coins_number.text = str(PlayerInventory.coins)
	health_number.text = str(PlayerStats.health)
	wood_number.text = str(PlayerInventory.wood)
	brick_number.text = str(PlayerInventory.brick)
